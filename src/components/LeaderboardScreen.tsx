...
import { Trophy, Medal, RefreshCw, ArrowLeft, Clock, Filter, Settings, BarChart2 } from 'lucide-react';
...
export default function LeaderboardScreen({ highlightCode, products, onBack, onAdmin }: Props) {
  ...
  const getProductName = (productId: string) => {
    return products.find(p => p.id === productId)?.product_code ?? '—';
  };
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="col-span-4 flex items-center gap-2">
                        <div className="w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: '#003087' }}>
                        ...
                        <div className="min-w-0">
                          ...
                          {isMe && (
                            <span className="text-xs bg-yellow-100 text-yellow-700 px-1.5 py-0.5 rounded font-semibold">You</span>
                          )}
                        </div>
                      </div>
